class AvaliacaoConhecimentoQuestaoLink < ApplicationRecord
  belongs_to :avaliacao_conhecimento_questao, optional: true

  audited on: [:update, :destroy]	

  validates :avaliacao_conhecimento_questao_id, :tipo_link, presence: true
  ...
  def obrigatorio_descricao?
    ['indicacao_filme', 'indicacao_livro', 'site', 'podcast'].include?(self.tipo_link) and self.link_base_copia_id.nil?
  end
end
